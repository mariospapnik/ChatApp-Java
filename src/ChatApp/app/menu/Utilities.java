...
public class Utilities {
    ...
    // Old Method that clears the screen
    public final static void clrscrOld(){
        try {
    ...
    public final static String repeatChar(char c, int length) {
    ...
    public final static void showExpBox(String str) {
        //Setting the chars
        char UR = 0x2510;
        char DL = 0x2514;
        char DR = 0x2518;
    ...
    public final static void pauseExecution() {
        pauseExecution("Press Enter to Continue... ");
    }

    public final static void pauseExecution(String message) {
     ...
     */
    public final static boolean requestConfirmation() {
        return requestConfirmation("Confirm Operation (y/n)... ");
    }

    public final static boolean requestConfirmation(String message) {
        String in = "";
        if(console == null) console = System.console();
