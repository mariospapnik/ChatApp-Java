...
public class MenuItem {
	...
	public MenuItem(String label, Object obj, String target) {
		this( label, obj, target, null);
	}

	public MenuItem(String label, Object obj, String target, Object param) {
		this.label = label;
		this.obj = obj;
		this.target = target;
		this.param = param;
	...
	void invoke() {
		...
		try {
			if(param==null) {
				...
				Method method = obj.getClass().getMethod(target, param.getClass());
